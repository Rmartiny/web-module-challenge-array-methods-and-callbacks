...
function getAverageGoals(CB) {
    ...
    let homeReduce= CB.reduce ((acc,team) =>{ return acc + team['Home Team Goals'] / CB.length},0);
     let awayReduce = CB.reduce ((acc,team)=> { return acc + team[ 'Away Team Goals']/CB.length},0);
